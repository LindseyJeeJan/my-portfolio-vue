<template>
  <footer class="p-2">
    <article class="contacts container">
      ...
      <a
        class="button"
        aria-label="Stack Overflow account"
        href="https://stackoverflow.com/users/8016495/lindseyjj"
        rel="noreferrer"
        target="_blank"
      >
        <span class="svg">
      ...
      <a
        class="button"
        href="mailto:ljjlauria@mac.com"
        aria-label="email Lindsey Lauria"
      >
        <span class="svg">
          <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    <p class="copyright">&copy; 2022 Lindsey Lauria</p>
  </footer>
</template>
